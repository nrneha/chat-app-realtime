...
urlpatterns = [
    ...
    path('account_otp/<int:user_id>',views.account_delete_otp_sending,name="account_otp"),
    ...
    path('reset_otp_verify/<str:p_otp>/<int:user_id>',views.passwordReset_verify_otp,name="reset_otp_verify"),
